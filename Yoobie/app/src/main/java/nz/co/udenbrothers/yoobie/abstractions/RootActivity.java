...
public abstract class RootActivity extends AppCompatActivity {
    ...
    protected final void initService(Class servClass){
        startService(new Intent(this, servClass));
    }
    ...
    public final void clearActivity(Class actClass){
        Intent intent = new Intent(this, actClass);
